...
echo "[*] Applying remediation for: $RULE_ID (Disable IPv4 ICMP redirects by default)"
...
# Comment out any occurrences of net.ipv4.conf.default.accept_redirects from relevant config files
...
#
echo "[*] Setting runtime value to $sysctl_net_ipv4_conf_default_accept_redirects_value"
if ! /bin/false ; then
...
echo "[+] Remediation complete: $SYSCTL_KEY is set to $sysctl_net_ipv4_conf_default_accept_redirects_value (runtime and persistent)."
