...
echo "[*] Applying remediation for: $RULE_ID (ensure pam_pwhistory is enabled)"

(>&2 echo "Remediating rule 38/405: 'xccdf_org.ssgproject.content_rule_accounts_password_pam_pwhistory_enabled'")
