...
echo "[*] Applying remediation for: $RULE_ID (Disable TFTP service - tftpd-hpa)"
...
echo "[+] Remediation complete. TFTP service is disabled and masked."
